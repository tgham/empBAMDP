...
Path_Load_group = "src/GoldExp2Data/Figures/GroupLevel/"
...
for i_GB = 1:2
    ...
    for i_sub = subjectIDs
        ...
        chnemp_df_set1 = 
                    chnemp_df_set1[1:sample_lenght:size(chnemp_df_set1)[1],:]
        ...
        chnemp_df_set2 = 
                    chnemp_df_set2[1:sample_lenght:size(chnemp_df_set2)[1],:]
    ...
    push!(chnemp_dfsAllPlusOthers,chnemp_dfsPlusOthers)
end

save(Path_Save * "BMSbasedLHat_CV.jld2", 
        "chnemp_dfsAll", chnemp_dfsAll, 
        "chnemp_dfsAllPlusOthers", chnemp_dfsAllPlusOthers,
