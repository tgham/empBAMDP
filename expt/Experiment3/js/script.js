...
function initialize_agentgoal() {
    ...
    <div class="container">
        <img src="img/BaseAction.png" alt="Base Action Image" class="base-image">
        <img id="agent" src="img/Agent.png" alt="Agent Image" class="agent-image"> 
        <img id="goal" src="img/Goal.png" alt="Goal Image" class="goal-image"> 
    </div>`;
}

function initialize_agentbomb() {
    return `
    <div class="container">
        <img src="img/BaseBomb.png" alt="Base Action Image" class="base-image">
        <img id="agent" src="img/Agent.png" alt="Agent Image" class="agent-image">
    </div>`;
}

function initialize_agentbomb_selection(agentid) {
    return `<div class="selection-container-small">
        <img src="img/BaseBomb.png" alt="Base Action Image" class="base-image">
        <img id="agent` + agentid + `" src="img/Agent.png" alt="Agent Image" class="agent-image">    
    </div>`;
...
function initialize_agentbombgoal() {
    return `
    <div class="container">
        <img src="img/BaseBomb.png" alt="Base Action Image" class="base-image">
        <img id="agent" src="img/Agent.png" alt="Agent Image" class="agent-image"> 
        <img id="goal" src="img/Safe.png" alt="Goal Image" class="goal-image"> 
    </div>`;
}
...
function showactionsbomb(room_index, rowid) {
    Room = allrooms[room_index]
    n = Object.keys(Room).length
    ...
    Object.entries(Room).forEach(([action, T]) => {
        ...
        // Create the base image
        const baseImage = document.createElement('img');
        baseImage.src = 'img/BaseBomb.png';
        baseImage.alt = 'Base Action Image';
        baseImage.className = 'base-image';
        container.appendChild(baseImage);
...
function selection_showactionsbomb(room_index, rowid) {
    Room = allrooms[room_index]
    n = Object.keys(Room).length
    ...
    Object.entries(Room).forEach(([action, T]) => {
        ...
        // Create the base image
        const baseImage = document.createElement('img');
        baseImage.src = 'img/BombAction.png';
        baseImage.alt = 'Base Action Image';
        baseImage.className = 'base-image';
        container.appendChild(baseImage);
