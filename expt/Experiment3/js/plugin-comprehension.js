var jsPsychGold1stepComprehension = (function (jspsych) {
  ...
  class Gold1ComprehensionPlugin {
    ...
    trial(display_element, trial) {
      ...
      // Add question text
      html += '<p class="jspsych-survey-multi-choice-text survey-multi-choice"><strong>1. What are you supposed to do in the 2nd part of the experiment?</strong></p>';
      ...
      html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-1-2">To <strong>choose</strong> the room where you feel more in <strong>control</strong>.</label>';
      html += '</div>';
      ...
      // Add question text
      html += '<p class="jspsych-survey-multi-choice-text survey-multi-choice"><strong>2. How can you earn most bonus in the 2nd part of the experiment?</strong></p>';
      ...
      html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-2-0">By collecting <strong>more gold</strong> coins.</label>';
      html += '</div>';

      // Option 2:
      html += '<div id="jspsych-survey-multi-choice-option-2-1" class="jspsych-survey-multi-choice-option">';
      html += '<input type="radio" name="jspsych-survey-multi-choice-response-2" id="jspsych-survey-multi-choice-response-2-1" value=2 required>';
      html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-2-1">By <strong>paying attention</strong> to the different rooms when answering the questions.</label>';
      html += '</div>';

      // Option 3:
      html += '<div id="jspsych-survey-multi-choice-option-2-2" class="jspsych-survey-multi-choice-option">';
      html += '<input type="radio" name="jspsych-survey-multi-choice-response-2" id="jspsych-survey-multi-choice-response-2-2" value=3 required>';
      html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-2-2">There is <strong>no bonus</strong> for this part.</label>';
      html += '</div>';
      ...
      // Add question text
      html += '<p class="jspsych-survey-multi-choice-text survey-multi-choice"><strong>3. Which of the following statements is correct?</strong></p>';
      ...
      html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-3-2">It is <strong>always possible</strong> to reach all locations of a room.</label>';
      html += '</div>';
      ...
      // Add question text
      html += '<p class="jspsych-survey-multi-choice-text survey-multi-choice"><strong>4. This is another example where it is easy to say in which room you have more control. Which room do you choose?</strong></p>';
      ...
      html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-0-0"><strong>Room 1</strong>.</label>';
      html += '</div>';
      ...
      html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-0-1"><strong>Room 2</strong></label>';
      html += '</div>';
      ...
      html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-0-2">The two rooms are <strong>similar</strong>.</label>';
      html += '</div>';
      ...
      // html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-0-3"><strong>No</strong>, the two rooms are similar.</label>';
      // html += '</div>';
      ...
      display_element.querySelector('#jspsych-survey-multi-choice-0').addEventListener('change', function(){
        ...
        if (val === "2") {
          ...
          // Update text
          Q1.innerHTML = "That's incorrect. <br>Hint: Think about potential locations in the room you may want to visit. <br>For each room, think about how you can reach these locations. Then, ask yourself in which room it is easier to reach them.";
      ...
      display_element.querySelector('#jspsych-survey-multi-choice-3').addEventListener('change', function(){
        ...
        if (val === "1") {
          ...
          // Update text
          Q4.innerHTML = "That's incorrect. <br>Think about the gold-collecting trials you did before!";
...
var jsPsychGold1stepComprehension2 = (function (jspsych) {
  ...
  class Gold1ComprehensionPlugin2 {
    ...
    trial(display_element, trial) {
      ...
      // Add question text
      html += '<p class="jspsych-survey-multi-choice-text survey-multi-choice"><strong>1. Consider the room below. <br>How could we change this room so that you would have more control?</strong></p>';
      ...
      html += '<div id="jspsych-survey-multi-choice-option-1-2" class="jspsych-survey-multi-choice-option">';
      html += '<input type="radio" name="jspsych-survey-multi-choice-response-1" id="jspsych-survey-multi-choice-response-1-2" value="3" required>';
      html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-1-2">You already have <strong>the maximum level of control</strong> in this room</label>';
      html += '</div>';
      ...
      // Add question text
      html += '<p class="jspsych-survey-multi-choice-text survey-multi-choice"><strong>2. This is another example where it is easy to say in which room you have more control. Which room do you choose?</strong></p>';

      // Option 1:
      html += '<div id="jspsych-survey-multi-choice-option-3-0" class="jspsych-survey-multi-choice-option">';
      html += '<input type="radio" name="jspsych-survey-multi-choice-response-3" id="jspsych-survey-multi-choice-response-3-0" value=1 required>';
      html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-3-0"><strong>Room 1</strong>.</label>';
      html += '</div>';

      // Option 2:
      html += '<div id="jspsych-survey-multi-choice-option-3-1" class="jspsych-survey-multi-choice-option">';
      html += '<input type="radio" name="jspsych-survey-multi-choice-response-3" id="jspsych-survey-multi-choice-response-3-1" value=2 required>';
      html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-3-1"><strong>Room 2</strong>.</label>';
      html += '</div>';

      // Option 3:
      html += '<div id="jspsych-survey-multi-choice-option-3-2" class="jspsych-survey-multi-choice-option">';
      html += '<input type="radio" name="jspsych-survey-multi-choice-response-3" id="jspsych-survey-multi-choice-response-3-2" value=3 required>';
      html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-3-2">The two rooms are <strong>similar</strong>.</label>';
      html += '</div>';
      ...
      // Add question text
      html += '<p class="jspsych-survey-multi-choice-text survey-multi-choice"><strong>3. This is another example where it is easy to say in which room you have more control. Which room do you choose?</strong></p>';
      ...
      html += '<div id="jspsych-survey-multi-choice-option-0-2" class="jspsych-survey-multi-choice-option">';
      html += '<input type="radio" name="jspsych-survey-multi-choice-response-0" id="jspsych-survey-multi-choice-response-0-2" value="3" required>';
      html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-0-2">The two rooms are <strong>similar</strong>.</label></label>';
      html += '</div>';
      ...
      display_element.querySelector('#jspsych-survey-multi-choice-1').addEventListener('change', function(){
        ...
        if (val === "3") {
          ...
          // Update text
          Q2.innerHTML = "That's incorrect. <br>Hint: Think about potential locations in the room you may want to visit. <br>Think about how you can reach these locations.";
          Q2.className = "invalid"
      ...
      display_element.querySelector('#jspsych-survey-multi-choice-3').addEventListener('change', function(){
        ...
        if (val === "1") {
          ...
          // Update text
          Q4.innerHTML = "That's incorrect. <br>Hint: Think about potential locations in the room you may want to visit. <br>For each room, think about how you can reach these locations. Then, ask yourself in which room it is easier to reach them.";
          Q4.className = "invalid"
...
var jsPsychGold1stepComprehension3 = (function (jspsych) {
  ...
  class Gold1ComprehensionPlugin3 {
    ...
    trial(display_element, trial) {
      ...
      html += '<div id="jspsych-survey-multi-choice-option-3-2" class="jspsych-survey-multi-choice-option">';
      html += '<input type="radio" name="jspsych-survey-multi-choice-response-3" id="jspsych-survey-multi-choice-response-3-2" value=3 required>';
      html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-3-2"><strong>No</strong>, the two rooms are similar.</label>';
      html += '</div>';
      ...
      html += '<div id="jspsych-survey-multi-choice-option-0-2" class="jspsych-survey-multi-choice-option">';
      html += '<input type="radio" name="jspsych-survey-multi-choice-response-0" id="jspsych-survey-multi-choice-response-0-2" value="3" required>';
      html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-0-2"><strong>No</strong>, the two rooms are similar.</label></label>';
      html += '</div>';
...
var jsPsychGold1stepComprehensionBG = (function (jspsych) {
  ...
  class Gold1ComprehensionPluginBG {
    ...
    trial(display_element, trial) {
      ...
      html += '<div id="jspsych-survey-multi-choice-option-0-2" class="jspsych-survey-multi-choice-option">';
      html += '<input type="radio" name="jspsych-survey-multi-choice-response-0" id="jspsych-survey-multi-choice-response-0-2" value="3" required>';
      html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-0-2"><strong>No</strong>, the two rooms are similar.</label>';
      html += '</div>';
