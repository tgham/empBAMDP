var jsPsychSurveyTemplate = (function (jspsych) {
  ...
  const info = {
    ...
    parameters: {
      ...
      if_skip_first: {
        type: jspsych.ParameterType.BOOL,
        pretty_name: 'Whether to skip first',
        default:  false,
        description: 'Whether the 1st response is to skip the question.'
      },
      if_skip_last: {
        type: jspsych.ParameterType.BOOL,
        pretty_name: 'Whether to skip last',
        default:  false,
        description: 'Whether the last response is to skip the question.'
      },
    }
  }
    ...
    trial(display_element, trial) {
      ...
      display_element.querySelector('#survey-template-submit').addEventListener('submit', function(event) {
        ...
        var trialdata = {
          ...
          "items": trial.items,
          "scale": trial.scale,
          "infrequency_items": trial.infrequency_items,
        };
