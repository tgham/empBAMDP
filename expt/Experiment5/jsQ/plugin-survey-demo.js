  ...
  */
  class SurveyDemoPlugin {
    ...
    trial(display_element, trial) {
      ...
      html += '<label><input type="radio" name="gender" value="Rather not say" required><strong>Skip</strong></label>';
      html += '</div></div>';
      ...
      html += '<label><input type="radio" name="sex" value="Rather not say" required><strong>Skip</strong></label>';
      html += '</div></div>';
      ...
      // html += '<label><input type="radio" name="ethnicity" value="Rather not say" required><strong>Skip</strong></label>';
      // html += '</div></div>';
      ...
      // html += '<label><input type="checkbox" name="race" value="Rather not say"><strong>Skip</strong></label>';
      // html += '</div></div>';
      ...
      html += '<label><input type="radio" name="education" value="Rather not say" required><strong>Skip</strong></label>';
      html += '</div></div>';
