var jsPsychGold1stepComprehension = (function (jspsych) {
  ...
  class Gold1ComprehensionPlugin {
    ...
    trial(display_element, trial) {
      ...
      // // Add question text
      // html += '<p class="jspsych-survey-multi-choice-text survey-multi-choice"><strong>2. Do your choices influence your bonus in this experiment?</strong></p>';
      ...
      // html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-2-0"><strong>No</strong>, because you are not supposed to collect gold.</label>';
      // html += '</div>';
      ...
      // html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-2-1"><strong>No</strong>, because all rooms are equally good for collecting gold.</label>';
      // html += '</div>';
      ...
      // html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-2-2"><strong>Yes</strong>, because some rooms are better for collecting gold than others.</label>';
      // html += '</div>';

      
      // // // Option 4:
      // // html += '<div id="jspsych-survey-multi-choice-option-2-3" class="jspsych-survey-multi-choice-option">';
      // // html += '<input type="radio" name="jspsych-survey-multi-choice-response-2" id="jspsych-survey-multi-choice-response-2-3" value="4" required>';
      // // html += '<label class="jspsych-survey-multi-choice-text" for="jspsych-survey-multi-choice-response-2-3">There is <strong>NO</strong> influence on your bonus.</label>';
      // // html += '</div>';
      ...
      // Show preamble text
      html += '<div class="jspsych-survey-multi-choice-preamble"><img src="./img/Comprehension/Slide1.png" style="max-width: 40%"></img></div>';
...
var jsPsychGold1stepComprehension2 = (function (jspsych) {
  ...
  class Gold1ComprehensionPlugin2 {
    ...
    trial(display_element, trial) {
      ...
      // Show preamble text
      html += '<div class="jspsych-survey-multi-choice-preamble"><img src="./img/Comprehension/Slide2.png" style="max-width: 45%"></img></div>';
      ...
      // Show preamble text
      html += '<div class="jspsych-survey-multi-choice-preamble"><img src="./img/Comprehension/Slide3.png" style="max-width: 45%"></img></div>';
      ...
      // Show preamble text
      html += '<div class="jspsych-survey-multi-choice-preamble"><img src="./img/Comprehension/Slide4.png" style="max-width: 45%"></img></div>';
